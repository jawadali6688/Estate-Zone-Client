  ...
  const Footer = () => {
    ...
    return (
      <div className="app min-h-screen flex items-end justify-center font-poppins">
        <div className="py-16 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 bg-gray-200 text-blue-600 gap-4 w-full p-4 relative">
          <div className="  ">
            <div className="footer-img my-4 flex items-center">
             
              <span className="text-3xl font-bold pl-2 text-blue-600">
                Estate Zone
              </span>
            </div>
            <div className="infos text-gray-600 my-4">
              <span>Copyright © 2024 Estate Zone ltd.</span>
            ...
            <div className="footer-icons flex items-center space-x-3">
              {socialLinks.map((socialLink, index) => {
                ...
                return (
                  <Icon
                    key={`social-${index}`}
                    className="w-14 h-14 p-2 rounded-full bg-blue-700 text-white hover:bg-white hover:text-green-700 cursor-pointer"
                  />
                );
              })}
            </div>
